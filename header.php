					...
					<div class="container">
						<div class="row">
							<div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-0 order-0">
								<div class="logo">
									<a href="<?php bloginfo('stylesheet_directory'); ?>/#"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/logo.png" alt=""></a>
							...
							<div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-2 order-1" style="text-align: right">
								<a href="<?php bloginfo('stylesheet_directory'); ?>/#" class="icon-cart">
									<div class="icon">
